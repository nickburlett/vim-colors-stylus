let g:airline#themes#stylus#palette = {}

function! airline#themes#stylus#refresh()
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Options
  """"""""""""""""""""""""""""""""""""""""""""""""
  let s:background  = get(g:, 'airline_stylus_bg', &background)
  ...
  " Inactive, according to VertSplit in stylus
  ...
  let g:airline#themes#stylus#palette.accents = {
        \ 'red': s:NFa,
        \ }

  let g:airline#themes#stylus#palette.inactive = airline#themes#generate_color_map(
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]])
  let g:airline#themes#stylus#palette.inactive_modified = {
        \ 'airline_c': [s:NMi[0].g, '', s:NMi[0].t, '', s:NMi[2]]}

  let g:airline#themes#stylus#palette.normal = airline#themes#generate_color_map(
  ...
  let g:airline#themes#stylus#palette.insert.airline_warning =
        \ g:airline#themes#stylus#palette.normal.airline_warning

  let g:airline#themes#stylus#palette.insert_modified = {
  ...
  let g:airline#themes#stylus#palette.tabline.airline_tab = [
        \ s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]]

  let g:airline#themes#stylus#palette.tabline.airline_tabtype = [
        \ s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]]
endfunction

call airline#themes#stylus#refresh()
